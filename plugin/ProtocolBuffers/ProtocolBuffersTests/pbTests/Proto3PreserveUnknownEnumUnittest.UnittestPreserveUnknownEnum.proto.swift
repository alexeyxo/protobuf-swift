...
public extension Proto3PreserveUnknownEnumUnittest {
    ...
    public enum MyEnum:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
        case foo = 0
        case bar = 1
        case baz = 2
    ...
    public enum MyEnumPlusExtra:Int32, CustomDebugStringConvertible, CustomStringConvertible, Hashable {
        case eFoo = 0
        case eBar = 1
        case eBaz = 2
        case eExtra = 3
