...
public extension ProtobufUnittestImport {
  ...
  final public class PublicImportMessage : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream) throws -> ProtobufUnittestImport.PublicImportMessage.Builder {
           return try mergeFrom(codedInputStream: &codedInputStream, extensionRegistry:ExtensionRegistry())
      }
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> ProtobufUnittestImport.PublicImportMessage.Builder {
...
extension ProtobufUnittestImport.PublicImportMessage: GeneratedMessageProtocol {
  ...
  public class func parseFrom(codedInputStream: inout CodedInputStream) throws -> ProtobufUnittestImport.PublicImportMessage {
    return try ProtobufUnittestImport.PublicImportMessage.Builder().mergeFrom(codedInputStream: &codedInputStream).build()
  }
  public class func parseFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> ProtobufUnittestImport.PublicImportMessage {
