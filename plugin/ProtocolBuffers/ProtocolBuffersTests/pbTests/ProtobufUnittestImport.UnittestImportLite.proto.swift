...
public extension ProtobufUnittestImport {
  ...
  final public class ImportMessageLite : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream) throws -> ProtobufUnittestImport.ImportMessageLite.Builder {
           return try mergeFrom(codedInputStream: &codedInputStream, extensionRegistry:ExtensionRegistry())
      }
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> ProtobufUnittestImport.ImportMessageLite.Builder {
...
extension ProtobufUnittestImport.ImportMessageLite: GeneratedMessageProtocol {
  ...
  public class func parseFrom(codedInputStream: inout CodedInputStream) throws -> ProtobufUnittestImport.ImportMessageLite {
    return try ProtobufUnittestImport.ImportMessageLite.Builder().mergeFrom(codedInputStream: &codedInputStream).build()
  }
  public class func parseFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> ProtobufUnittestImport.ImportMessageLite {
