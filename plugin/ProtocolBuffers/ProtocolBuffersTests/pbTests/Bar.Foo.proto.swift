...
public extension Bar {
  ...
  final public class Foo : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream) throws -> Bar.Foo.Builder {
           return try mergeFrom(codedInputStream: &codedInputStream, extensionRegistry:ExtensionRegistry())
      }
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Bar.Foo.Builder {
...
extension Bar.Foo: GeneratedMessageProtocol {
  ...
  public class func parseFrom(codedInputStream: inout CodedInputStream) throws -> Bar.Foo {
    return try Bar.Foo.Builder().mergeFrom(codedInputStream: &codedInputStream).build()
  }
  public class func parseFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Bar.Foo {
