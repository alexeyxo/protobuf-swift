...
public extension ProtobufUnittestImport {
  ...
  final public class ImportMessage  {
    ...
    class public func decode(jsonMap:Dictionary<String,Any>) throws -> ProtobufUnittestImport.ImportMessage {
      return try ProtobufUnittestImport.ImportMessage.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    class public func fromJSON(data:Data) throws -> ProtobufUnittestImport.ImportMessage {
    ...
    final public class Builder : GeneratedMessageBuilderProtocol {
      ...
      public var internalGetResult:ProtobufUnittestImport.ImportMessage {
           get {
              return builderResult
           }
          set{}
      ...
      @discardableResult
      public func clear() -> ProtobufUnittestImport.ImportMessage.Builder {
        builderResult = ProtobufUnittestImport.ImportMessage()
        return self
      }
      public func clone() throws -> ProtobufUnittestImport.ImportMessage.Builder {
        return try ProtobufUnittestImport.ImportMessage.builderWithPrototype(prototype:builderResult)
      }
      public func build() throws -> ProtobufUnittestImport.ImportMessage {
      ...
      @discardableResult
      public func mergeFrom(codedInputStream: CodedInputStream) throws -> ProtobufUnittestImport.ImportMessage.Builder {
           return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
      }
      @discardableResult
      public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> ProtobufUnittestImport.ImportMessage.Builder {
      ...
      class public func fromJSONToBuilder(data:Data) throws -> ProtobufUnittestImport.ImportMessage.Builder {
...
extension ProtobufUnittestImport.ImportMessage: GeneratedMessageProtocol {
  public static func getBuilder() -> GeneratedMessageBuilderProtocol {
    return ProtobufUnittestImport.ImportMessage.Builder() as! T
  }
