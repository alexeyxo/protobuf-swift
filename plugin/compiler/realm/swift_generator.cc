...
namespace google { namespace protobuf { namespace compiler { namespace swift {
    ...
    bool SwiftGenerator::Generate(const FileDescriptor* file,
        ...
        if (!NeedGenerateRealmFileClass(file)) {
            return true;
        }
        ...
        string filepath = FilePath(file);
        {
            ...
            scoped_ptr<io::ZeroCopyOutputStream> output(generator_context->Open(package_name + UnderscoresToCapitalizedCamelCase(UnderscoresToCapitalizedCamelCase(filepath)) + ".realm.proto.swift"));
            ...
            printer.Print("import RealmSwift\n");
