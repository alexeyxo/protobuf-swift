...
namespace google { namespace protobuf { namespace compiler { namespace swift {
    ...
    bool SwiftGenerator::Generate(const FileDescriptor* file,
        ...
        string filepath = FilePath(file);
        {
            ...
            this->GenerateSourcePackages(&printer, file);
            ...
            printer.Print("// Generated by the Protocol Buffers 3.0 compiler.  DO NOT EDIT!\n"
    ...
    void SwiftGenerator::GenerateSourcePackages(io::Printer* printer, const FileDescriptor* file) const {
