...
inline ::std::string* FileOptions::release_php_metadata_namespace() {
  ...
  clear_has_php_metadata_namespace();
  return php_metadata_namespace_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
...
inline ::std::string* FileOptions::release_ruby_package() {
  ...
  clear_has_ruby_package();
  return ruby_package_.Release(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
