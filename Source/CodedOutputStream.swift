...
public struct CodedOutputStream {
    ...
    public mutating func writeRawByte(byte aByte:UInt8) throws {
        while (!buffer.appendByte(byte: aByte)) {
            try flush()
        }
    }
    
    public mutating func writeRawData(data:Data) throws {
        try writeRawData(data: data, offset:0, length: data.count)
    }
    public mutating func writeRawData(data:Data, offset:Int, length:Int) throws {
        var aLength = length
        var aOffset = offset
        while (aLength > 0) {
    ...
    public mutating func writeDoubleNoTag(value:Double) throws {
    ...
    public mutating func writeDouble(fieldNumber:Int32, value aValue:Double) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.fixed64)
        try writeDoubleNoTag(value: aValue)
    }
    
    public mutating func writeFloatNoTag(value:Float) throws {
        var returnValue:Int32 = 0
        returnValue = WireFormat.convertTypes(convertValue: value, defaultValue:returnValue)
        try writeRawLittleEndian32(value: returnValue)
    }
    
    public mutating func writeFloat(fieldNumber:Int32, value aValue:Float) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.fixed32)
        try writeFloatNoTag(value: aValue)
    }
    
    public mutating func writeUInt64NoTag(value:UInt64) throws {
    ...
    public mutating func writeUInt64(fieldNumber:Int32, value:UInt64) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.varint)
        try writeUInt64NoTag(value: value)
    }
    
    public mutating func writeInt64NoTag(value:Int64) throws {
        try writeRawVarint64(value: value)
    }
    
    public mutating func writeInt64(fieldNumber:Int32, value aValue:Int64) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.varint)
        try writeInt64NoTag(value: aValue)
    }
    
    public mutating func writeInt32NoTag(value:Int32) throws {
        if value >= 0 {
    ...
    public mutating func writeInt32(fieldNumber:Int32, value:Int32) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.varint)
        try writeInt32NoTag(value: value)
    }
    
    public mutating func writeFixed64NoTag(value:UInt64) throws {
        var retvalue:Int64 = 0
        retvalue = WireFormat.convertTypes(convertValue: value, defaultValue:retvalue)
        try writeRawLittleEndian64(value: retvalue)
    }
    
    public mutating func writeFixed64(fieldNumber:Int32, value:UInt64) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.fixed64)
        try writeFixed64NoTag(value: value)
    }
    
    public mutating func writeFixed32NoTag(value:UInt32) throws {
        var retvalue:Int32 = 0
        retvalue = WireFormat.convertTypes(convertValue: value, defaultValue:retvalue)
        try writeRawLittleEndian32(value: retvalue)
    }
    
    public mutating func writeFixed32(fieldNumber:Int32, value:UInt32) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.fixed32)
        try writeFixed32NoTag(value: value)
    }
    
    public mutating func writeBoolNoTag(value:Bool) throws {
        try writeRawByte(byte: value ? 1 : 0)
    }
    
    public mutating func writeBool(fieldNumber:Int32, value:Bool) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.varint)
        try writeBoolNoTag(value: value)
    }
    
    public mutating func writeStringNoTag(value:String) throws {
        let data = value.utf8ToData()
        try writeRawVarint32(value: Int32(data.count))
        try writeRawData(data: data)
    }
    
    public mutating func writeString(fieldNumber:Int32, value:String) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.lengthDelimited)
        try writeStringNoTag(value: value)
    }
    
    public mutating func writeGroupNoTag(fieldNumber:Int32, value:ProtocolBuffersMessage) throws {
        try value.writeTo(codedOutputStream: &self)
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.endGroup)
    }
    
    public mutating func writeGroup(fieldNumber:Int32, value:ProtocolBuffersMessage) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.startGroup)
        try writeGroupNoTag(fieldNumber: fieldNumber, value: value)
    }
    
    public mutating func writeUnknownGroupNoTag(fieldNumber:Int32, value:UnknownFieldSet) throws {
        try value.writeTo(codedOutputStream: &self)
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.endGroup)
    }
    
    public mutating func writeUnknownGroup(fieldNumber:Int32, value:UnknownFieldSet) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.startGroup)
        try writeUnknownGroupNoTag(fieldNumber: fieldNumber, value:value)
    }
    
    public mutating func writeMessageNoTag(value:ProtocolBuffersMessage) throws {
        try writeRawVarint32(value: value.serializedSize())
        try value.writeTo(codedOutputStream: &self)
    }
    
    public mutating func writeMessage(fieldNumber:Int32, value:ProtocolBuffersMessage) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.lengthDelimited)
        try writeMessageNoTag(value: value)
    }
    
    public mutating func writeDataNoTag(data:Data) throws {
        try writeRawVarint32(value: Int32(data.count))
        try writeRawData(data: data)
    }
    
    public mutating func writeData(fieldNumber:Int32, value:Data) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.lengthDelimited)
        try writeDataNoTag(data: value)
    }
    
    public mutating func writeUInt32NoTag(value:UInt32) throws {
        var retvalue:Int32 = 0
        retvalue = WireFormat.convertTypes(convertValue: value, defaultValue:retvalue)
        try writeRawVarint32(value: retvalue)
    }
    
    public mutating func writeUInt32(fieldNumber:Int32, value:UInt32) throws {
        try writeTag(fieldNumber: fieldNumber, format: WireFormat.varint)
        try writeUInt32NoTag(value: value)
    }
    
    public mutating func writeEnumNoTag(value:Int32) throws {
        try writeRawVarint32(value: value)
    }
    
    public mutating func writeEnum(fieldNumber:Int32, value:Int32) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.varint)
        try writeEnumNoTag(value: value)
    }
    
    public mutating func writeSFixed32NoTag(value:Int32) throws {
        try writeRawLittleEndian32(value: value)
    }
    
    public mutating func writeSFixed32(fieldNumber:Int32, value:Int32) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.fixed32)
        try writeSFixed32NoTag(value: value)
    }

    public mutating func writeSFixed64NoTag(value:Int64) throws {
         try writeRawLittleEndian64(value: value)
    }
    
    public mutating func writeSFixed64(fieldNumber:Int32, value:Int64) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.fixed64)
        try writeSFixed64NoTag(value: value)
    }
    
    public mutating func writeSInt32NoTag(value:Int32) throws {
        try writeRawVarint32(value: WireFormat.encodeZigZag32(n: value))
    }
    
    public mutating func writeSInt32(fieldNumber:Int32, value:Int32) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.varint)
        try writeSInt32NoTag(value: value)
    }
    
    public mutating func writeSInt64NoTag(value:Int64) throws {
        try writeRawVarint64(value: WireFormat.encodeZigZag64(n: value))
    }
    
    public mutating func writeSInt64(fieldNumber:Int32, value:Int64) throws {
        try writeTag(fieldNumber: fieldNumber, format:WireFormat.varint)
        try writeSInt64NoTag(value: value)
    }
    
    public mutating func writeMessageSetExtension(fieldNumber:Int32, value:ProtocolBuffersMessage) throws {
    ...
    public mutating func writeRawMessageSetExtension(fieldNumber:Int32, value:Data) throws {
        try writeTag(fieldNumber: WireFormatMessage.setItem.rawValue, format:WireFormat.startGroup)
        try writeUInt32(fieldNumber: WireFormatMessage.setTypeId.rawValue, value:UInt32(fieldNumber))
    ...
    public mutating func writeTag(fieldNumber:Int32, format:WireFormat) throws {
        try writeRawVarint32(value: format.makeTag(fieldNumber: fieldNumber))
    }
    
    public mutating func writeRawLittleEndian32(value:Int32) throws {
    ...
    public mutating func writeRawLittleEndian64(value:Int64) throws {
        try writeRawByte(byte:UInt8(value & 0xFF))
        try writeRawByte(byte:UInt8((value >> 8) & 0xFF))
        try writeRawByte(byte:UInt8((value >> 16) & 0xFF))
        try writeRawByte(byte:UInt8((value >> 24) & 0xFF))
    ...
    public mutating func writeRawVarint32(value:Int32) throws {
    ...
    public mutating func writeRawVarint64(value:Int64) throws {
        var valueToWrite = value
        while (true) {
            if ((valueToWrite & ~0x7F) == 0) {
                try writeRawByte(byte:UInt8(valueToWrite))
