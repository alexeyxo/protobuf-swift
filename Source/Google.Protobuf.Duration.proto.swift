...
public extension Google.Protobuf {
  ...
  final public class Duration : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream) throws -> Google.Protobuf.Duration.Builder {
           return try mergeFrom(codedInputStream: &codedInputStream, extensionRegistry:ExtensionRegistry())
      }
      @discardableResult
      override public func mergeFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Duration.Builder {
...
extension Google.Protobuf.Duration: GeneratedMessageProtocol {
  ...
  public class func parseFrom(codedInputStream: inout CodedInputStream) throws -> Google.Protobuf.Duration {
    return try Google.Protobuf.Duration.Builder().mergeFrom(codedInputStream: &codedInputStream).build()
  }
  public class func parseFrom(codedInputStream: inout CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Google.Protobuf.Duration {
