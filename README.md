...
[![Build Status](https://travis-ci.org/alexeyxo/protobuf-swift.svg?branch=package)](https://travis-ci.org/alexeyxo/protobuf-swift) [![Version](http://img.shields.io/cocoapods/v/ProtocolBuffers-Swift.svg)](http://cocoapods.org/?q=ProtocolBuffers-Swift) [![Platform](http://img.shields.io/cocoapods/p/ProtocolBuffers-Swift.svg)](http://cocoapods.org/?q=ProtocolBuffers)
