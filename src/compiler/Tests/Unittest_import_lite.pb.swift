...
private class UnittestImportLiteRoot {
...
enum ImportEnumLite:Int32 {
  case ImportEnumLiteImportLiteFoo = 7
  case ImportEnumLiteImportLiteBar = 8
  case ImportEnumLiteImportLiteBaz = 9

  static func ImportEnumLiteIsValidValue(value:ImportEnumLite) ->Bool {
    switch value {
      case .ImportEnumLiteImportLiteFoo, .ImportEnumLiteImportLiteBar, .ImportEnumLiteImportLiteBaz:
        return true;
      default:
        return false;
    }
...
class ImportMessageLite : GeneratedMessage {
  ...
  class ImportMessageLiteBuilder : GeneratedMessageBuilder {
  private var result:ImportMessageLite

  override init () {
     result = ImportMessageLite()
  }
  var hasD:Bool {
       get {
            return result.hasD
  ...
  func build() -> ImportMessageLite {
       checkInitialized()
       return buildPartial()
  }
  func buildPartial() -> ImportMessageLite {
    var returnMe:ImportMessageLite = result
    return returnMe
  }
