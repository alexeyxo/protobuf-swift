  ...
  public struct Protobuf {
    ...
    public enum AccessControl:Int32 {
      ...
      public static func IsValidValue(value:Int32) ->Bool {
          if let check = Google.Protobuf.AccessControl(rawValue:value) {
              return true
          }
          return false
      }
    ...
    final public class SwiftFileOptions : GeneratedMessage, GeneratedMessageProtocol {
      ...
      public class func parseFromData(data:NSData) -> Google.Protobuf.SwiftFileOptions {
        return Google.Protobuf.SwiftFileOptions.builder().mergeFromData(data, extensionRegistry:SwiftDescriptorRoot.sharedInstance.extensionRegistry).build()
      }
