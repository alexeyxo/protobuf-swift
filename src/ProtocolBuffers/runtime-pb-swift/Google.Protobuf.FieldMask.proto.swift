...
public extension Google.Protobuf {
  ...
  final public class FieldMask : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    public class func parseFromData(data:NSData) -> Google.Protobuf.FieldMask {
    ...
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Google.Protobuf.FieldMask {
      return Google.Protobuf.FieldMask.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) -> Google.Protobuf.FieldMask {
      return Google.Protobuf.FieldMask.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) -> Google.Protobuf.FieldMask {
      return Google.Protobuf.FieldMask.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream) -> Google.Protobuf.FieldMask {
      return Google.Protobuf.FieldMask.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Google.Protobuf.FieldMask {
    ...
    public func toBuilder() -> Google.Protobuf.FieldMask.Builder {
      return Google.Protobuf.FieldMask.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Google.Protobuf.FieldMask) -> Google.Protobuf.FieldMask.Builder {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public override func clone() -> Google.Protobuf.FieldMask.Builder {
        return Google.Protobuf.FieldMask.builderWithPrototype(builderResult)
      }
      public override func build() -> Google.Protobuf.FieldMask {
           checkInitialized()
           return buildPartial()
      }
      ...
      public func mergeFrom(other:Google.Protobuf.FieldMask) -> Google.Protobuf.FieldMask.Builder {
      ...
      public override func mergeFromCodedInputStream(input:CodedInputStream) -> Google.Protobuf.FieldMask.Builder {
           return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Google.Protobuf.FieldMask.Builder {
