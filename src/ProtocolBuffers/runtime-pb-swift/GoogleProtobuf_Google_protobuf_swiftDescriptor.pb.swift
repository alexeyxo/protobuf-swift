...
public var GoogleProtobufSwiftDescriptorRootswiftFileOptions:ConcreateExtensionField {
   get {
       return Google.Protobuf.GoogleProtobufSwiftDescriptorRoot.sharedInstance.GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic
   }
}
public extension Google.Protobuf {
  public struct GoogleProtobufSwiftDescriptorRoot {
    public static var sharedInstance : GoogleProtobufSwiftDescriptorRoot {
     struct Static {
         static let instance : GoogleProtobufSwiftDescriptorRoot = GoogleProtobufSwiftDescriptorRoot()
     }
    ...
    public static func swiftFileOptions() -> ConcreateExtensionField {
         return GoogleProtobufSwiftDescriptorRoot.sharedInstance.GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic
    }
  }
  ...
  final public class SwiftFileOptions : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) -> Google.Protobuf.SwiftFileOptions {
      return Google.Protobuf.SwiftFileOptions.builder().mergeFromData(data, extensionRegistry:Google.Protobuf.GoogleProtobufSwiftDescriptorRoot.sharedInstance.extensionRegistry).build()
    }
