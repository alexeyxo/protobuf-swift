...
internal struct GoogleProtobufUnittestLiteImportsNonliteRoot {
  internal static var sharedInstance : GoogleProtobufUnittestLiteImportsNonliteRoot {
   struct Static {
       static let instance : GoogleProtobufUnittestLiteImportsNonliteRoot = GoogleProtobufUnittestLiteImportsNonliteRoot()
   }
  ...
  init() {
    ...
    GoogleProtobufUnittestRoot.sharedInstance.registerAllExtensions(extensionRegistry)
  }
...
internal extension ProtobufUnittest {
  final internal class TestLiteImportsNonlite : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestLiteImportsNonlite {
      return ProtobufUnittest.TestLiteImportsNonlite.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestLiteImportsNonliteRoot.sharedInstance.extensionRegistry).build()
    }
