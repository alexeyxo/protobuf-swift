...
internal var TestMessageSetExtension1messageSetExtension:ConcreateExtensionField {
   get {
       return GoogleProtobufUnittestMsetRoot.sharedInstance.TestMessageSetExtension1messageSetExtensionStatic
   }
}
internal var TestMessageSetExtension2messageSetExtension:ConcreateExtensionField {
   get {
       return GoogleProtobufUnittestMsetRoot.sharedInstance.TestMessageSetExtension2messageSetExtensionStatic
   }
}
...
internal extension ProtobufUnittest {
  final internal class TestMessageSet : ExtendableMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSet {
      return ProtobufUnittest.TestMessageSet.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestMsetRoot.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestMessageSetContainer : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSetContainer {
      return ProtobufUnittest.TestMessageSetContainer.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestMsetRoot.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestMessageSetExtension1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSetExtension1 {
      return ProtobufUnittest.TestMessageSetExtension1.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestMsetRoot.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestMessageSetExtension2 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSetExtension2 {
      return ProtobufUnittest.TestMessageSetExtension2.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestMsetRoot.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class RawMessageSet : GeneratedMessage, GeneratedMessageProtocol {
    ...
    //Nested type declaration start
      ...
      final internal class Item : GeneratedMessage, GeneratedMessageProtocol {
        ...
        private(set) var message:NSData = NSData()
        ...
        internal class func parseFromData(data:NSData) -> ProtobufUnittest.RawMessageSet.Item {
          return ProtobufUnittest.RawMessageSet.Item.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestMsetRoot.sharedInstance.extensionRegistry).build()
        }
      ...
      final internal class ItemBuilder : GeneratedMessageBuilder {
        ...
        func setMessage(value:NSData)-> ProtobufUnittest.RawMessageSet.ItemBuilder {
          self.message = value
          return self
        }
        internal func clearMessage() -> ProtobufUnittest.RawMessageSet.ItemBuilder{
             builderResult.hasMessage = false
             builderResult.message = NSData()
             return self
        }
        override internal var internalGetResult:GeneratedMessage {
             get {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.RawMessageSet {
      return ProtobufUnittest.RawMessageSet.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestMsetRoot.sharedInstance.extensionRegistry).build()
    }
