...
internal struct GoogleProtobufUnittestImportLiteRoot {
  ...
  init() {
    ...
    GoogleProtobufUnittestImportPublicLiteRoot.sharedInstance.registerAllExtensions(extensionRegistry)
  }
...
internal extension ProtobufUnittestImport {
  ...
  final internal class ImportMessageLite : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittestImport.ImportMessageLite {
      return ProtobufUnittestImport.ImportMessageLite.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestImportLiteRoot.sharedInstance.extensionRegistry).build()
    }
