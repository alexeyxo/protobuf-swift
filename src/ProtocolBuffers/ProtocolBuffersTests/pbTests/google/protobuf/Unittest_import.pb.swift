...
internal struct GoogleProtobufUnittestImportRoot {
  ...
  init() {
    ...
    GoogleProtobufUnittestImportPublicRoot.sharedInstance.registerAllExtensions(extensionRegistry)
  }
...
internal extension ProtobufUnittestImport {
  ...
  final internal class ImportMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittestImport.ImportMessage {
      return ProtobufUnittestImport.ImportMessage.builder().mergeFromData(data, extensionRegistry:GoogleProtobufUnittestImportRoot.sharedInstance.extensionRegistry).build()
    }
