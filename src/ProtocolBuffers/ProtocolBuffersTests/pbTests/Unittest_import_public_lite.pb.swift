...
final internal class PublicImportMessageLite : GeneratedMessage {
  ...
  internal class func builder() -> PublicImportMessageLiteBuilder {
    return PublicImportMessageLite.classBuilder() as PublicImportMessageLiteBuilder
  }
  internal func builder() -> PublicImportMessageLiteBuilder {
    return classBuilder() as PublicImportMessageLiteBuilder
  }
...
internal extension PublicImportMessageLite {
    class func parseFromNSData(data:NSData) -> PublicImportMessageLite {
        ...
        data.getBytes(&bytes)
        return PublicImportMessageLite.builder().mergeFromData(bytes, extensionRegistry:UnittestImportPublicLiteRoot.sharedInstance.extensionRegistry).build()
    }
