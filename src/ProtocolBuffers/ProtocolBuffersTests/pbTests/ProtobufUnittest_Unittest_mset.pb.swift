...
internal var TestMessageSetExtension1messageSetExtension:ConcreateExtensionField {
   get {
       return ProtobufUnittest.UnittestMsetProto.sharedInstance.TestMessageSetExtension1messageSetExtensionStatic
   }
}
internal var TestMessageSetExtension2messageSetExtension:ConcreateExtensionField {
   get {
       return ProtobufUnittest.UnittestMsetProto.sharedInstance.TestMessageSetExtension2messageSetExtensionStatic
   }
}
internal extension ProtobufUnittest {
  internal struct UnittestMsetProto {
    internal static var sharedInstance : UnittestMsetProto {
     struct Static {
         static let instance : UnittestMsetProto = UnittestMsetProto()
     }
  ...
  final internal class TestMessageSet : ExtendableMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSet {
      return ProtobufUnittest.TestMessageSet.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestMsetProto.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestMessageSetContainer : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSetContainer {
      return ProtobufUnittest.TestMessageSetContainer.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestMsetProto.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestMessageSetExtension1 : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSetExtension1 {
      return ProtobufUnittest.TestMessageSetExtension1.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestMsetProto.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestMessageSetExtension2 : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestMessageSetExtension2 {
      return ProtobufUnittest.TestMessageSetExtension2.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestMsetProto.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class RawMessageSet : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    //Nested type declaration start
      ...
      final internal class Item : GeneratedMessage, GeneratedMessageProtocol, Hashable {
        ...
        internal class func parseFromData(data:NSData) -> ProtobufUnittest.RawMessageSet.Item {
          return ProtobufUnittest.RawMessageSet.Item.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestMsetProto.sharedInstance.extensionRegistry).build()
        }
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.RawMessageSet {
      return ProtobufUnittest.RawMessageSet.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestMsetProto.sharedInstance.extensionRegistry).build()
    }
