...
internal extension ProtobufUnittestImport {
  internal struct GoogleProtobufUnittestImportRoot {
    internal static var sharedInstance : GoogleProtobufUnittestImportRoot {
     struct Static {
         static let instance : GoogleProtobufUnittestImportRoot = GoogleProtobufUnittestImportRoot()
     }
    ...
    init() {
      ...
      ProtobufUnittestImport.GoogleProtobufUnittestImportPublicRoot.sharedInstance.registerAllExtensions(extensionRegistry)
    }
  ...
  final internal class ImportMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittestImport.ImportMessage {
      return ProtobufUnittestImport.ImportMessage.builder().mergeFromData(data, extensionRegistry:ProtobufUnittestImport.GoogleProtobufUnittestImportRoot.sharedInstance.extensionRegistry).build()
    }
