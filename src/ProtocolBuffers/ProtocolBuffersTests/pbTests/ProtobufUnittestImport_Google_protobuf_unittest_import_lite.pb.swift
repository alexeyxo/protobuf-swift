...
internal extension ProtobufUnittestImport {
  internal struct GoogleProtobufUnittestImportLiteRoot {
    internal static var sharedInstance : GoogleProtobufUnittestImportLiteRoot {
     struct Static {
         static let instance : GoogleProtobufUnittestImportLiteRoot = GoogleProtobufUnittestImportLiteRoot()
     }
    ...
    init() {
      ...
      ProtobufUnittestImport.GoogleProtobufUnittestImportPublicLiteRoot.sharedInstance.registerAllExtensions(extensionRegistry)
    }
  ...
  final internal class ImportMessageLite : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittestImport.ImportMessageLite {
      return ProtobufUnittestImport.ImportMessageLite.builder().mergeFromData(data, extensionRegistry:ProtobufUnittestImport.GoogleProtobufUnittestImportLiteRoot.sharedInstance.extensionRegistry).build()
    }
