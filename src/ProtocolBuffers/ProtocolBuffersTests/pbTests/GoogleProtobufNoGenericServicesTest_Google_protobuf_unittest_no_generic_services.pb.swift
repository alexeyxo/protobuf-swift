...
internal var GoogleProtobufUnittestNoGenericServicesRoottestExtension:ConcreateExtensionField {
   get {
       return Google.Protobuf.NoGenericServicesTest.GoogleProtobufUnittestNoGenericServicesRoot.sharedInstance.GoogleProtobufUnittestNoGenericServicesRoottestExtensionStatic
   }
}
internal extension Google.Protobuf.NoGenericServicesTest {
  internal struct GoogleProtobufUnittestNoGenericServicesRoot {
    internal static var sharedInstance : GoogleProtobufUnittestNoGenericServicesRoot {
     struct Static {
         static let instance : GoogleProtobufUnittestNoGenericServicesRoot = GoogleProtobufUnittestNoGenericServicesRoot()
     }
     return Static.instance
    }
    var GoogleProtobufUnittestNoGenericServicesRoottestExtensionStatic:ConcreateExtensionField
    internal var extensionRegistry:ExtensionRegistry

    init() {
      GoogleProtobufUnittestNoGenericServicesRoottestExtensionStatic = ConcreateExtensionField(type:ExtensionType.ExtensionTypeInt32, extendedClass:Google.Protobuf.NoGenericServicesTest.TestMessage.self, fieldNumber: 1000, defaultValue:Int32(0), messageOrGroupClass:Int32.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
      extensionRegistry = ExtensionRegistry()
      registerAllExtensions(extensionRegistry)
    }
    internal func registerAllExtensions(registry:ExtensionRegistry) {
      registry.addExtension(GoogleProtobufUnittestNoGenericServicesRoottestExtensionStatic)
    }
    internal static func testExtension() -> ConcreateExtensionField {
         return GoogleProtobufUnittestNoGenericServicesRoot.sharedInstance.GoogleProtobufUnittestNoGenericServicesRoottestExtensionStatic
    }
  }
  ...
  final internal class TestMessage : ExtendableMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> Google.Protobuf.NoGenericServicesTest.TestMessage {
      return Google.Protobuf.NoGenericServicesTest.TestMessage.builder().mergeFromData(data, extensionRegistry:Google.Protobuf.NoGenericServicesTest.GoogleProtobufUnittestNoGenericServicesRoot.sharedInstance.extensionRegistry).build()
    }
