...
internal var TestOptimizedForSizetestExtension:ConcreateExtensionField {
   get {
       return ProtobufUnittest.UnittestOptimizeForProto.sharedInstance.TestOptimizedForSizetestExtensionStatic
   }
}
internal var TestOptimizedForSizetestExtension2:ConcreateExtensionField {
   get {
       return ProtobufUnittest.UnittestOptimizeForProto.sharedInstance.TestOptimizedForSizetestExtension2Static
   }
}
internal extension ProtobufUnittest {
  internal struct UnittestOptimizeForProto {
    internal static var sharedInstance : UnittestOptimizeForProto {
     struct Static {
         static let instance : UnittestOptimizeForProto = UnittestOptimizeForProto()
     }
  ...
  final internal class TestOptimizedForSize : ExtendableMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestOptimizedForSize {
      return ProtobufUnittest.TestOptimizedForSize.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestOptimizeForProto.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestRequiredOptimizedForSize : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestRequiredOptimizedForSize {
      return ProtobufUnittest.TestRequiredOptimizedForSize.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestOptimizeForProto.sharedInstance.extensionRegistry).build()
    }
  ...
  final internal class TestOptionalOptimizedForSize : GeneratedMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestOptionalOptimizedForSize {
      return ProtobufUnittest.TestOptionalOptimizedForSize.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.UnittestOptimizeForProto.sharedInstance.extensionRegistry).build()
    }
