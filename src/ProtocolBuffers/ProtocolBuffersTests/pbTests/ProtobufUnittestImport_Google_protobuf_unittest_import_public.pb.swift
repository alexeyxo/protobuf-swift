...
internal extension ProtobufUnittestImport {
  internal struct GoogleProtobufUnittestImportPublicRoot {
    internal static var sharedInstance : GoogleProtobufUnittestImportPublicRoot {
     struct Static {
         static let instance : GoogleProtobufUnittestImportPublicRoot = GoogleProtobufUnittestImportPublicRoot()
     }
  ...
  final internal class PublicImportMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittestImport.PublicImportMessage {
      return ProtobufUnittestImport.PublicImportMessage.builder().mergeFromData(data, extensionRegistry:ProtobufUnittestImport.GoogleProtobufUnittestImportPublicRoot.sharedInstance.extensionRegistry).build()
    }
