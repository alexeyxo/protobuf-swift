...
internal extension Google.Protobuf.NoGenericServicesTest {
  ...
  final internal class TestMessage : ExtendableMessage, GeneratedMessageProtocol, Hashable {
    ...
    internal class func parseArrayDelimitedFromInputStream(input:NSInputStream) -> Array<Google.Protobuf.NoGenericServicesTest.TestMessage> {
    ...
    internal class func parseFromDelimitedFromInputStream(input:NSInputStream) -> Google.Protobuf.NoGenericServicesTest.TestMessage? {
      return Google.Protobuf.NoGenericServicesTest.TestMessage.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
