...
internal extension ProtobufUnittest {
  internal struct GoogleProtobufUnittestEmbedOptimizeForRoot {
    internal static var sharedInstance : GoogleProtobufUnittestEmbedOptimizeForRoot {
     struct Static {
         static let instance : GoogleProtobufUnittestEmbedOptimizeForRoot = GoogleProtobufUnittestEmbedOptimizeForRoot()
     }
    ...
    init() {
      ...
      ProtobufUnittest.GoogleProtobufUnittestOptimizeForRoot.sharedInstance.registerAllExtensions(extensionRegistry)
    }
  ...
  final internal class TestEmbedOptimizedForSize : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> ProtobufUnittest.TestEmbedOptimizedForSize {
      return ProtobufUnittest.TestEmbedOptimizedForSize.builder().mergeFromData(data, extensionRegistry:ProtobufUnittest.GoogleProtobufUnittestEmbedOptimizeForRoot.sharedInstance.extensionRegistry).build()
    }
