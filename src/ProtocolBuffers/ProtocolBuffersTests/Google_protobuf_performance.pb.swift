...
public struct GoogleProtobufPerformanceRoot {
  public static var sharedInstance : GoogleProtobufPerformanceRoot {
   struct Static {
       static let instance : GoogleProtobufPerformanceRoot = GoogleProtobufPerformanceRoot()
   }
  ...
  init() {
    ...
    Google.Protobuf.GoogleProtobufSwiftDescriptorRoot.sharedInstance.registerAllExtensions(extensionRegistry)
  }
...
final public class User : GeneratedMessage, GeneratedMessageProtocol {
  ...
  public class func parseFromData(data:NSData) -> User {
    return User.builder().mergeFromData(data, extensionRegistry:GoogleProtobufPerformanceRoot.sharedInstance.extensionRegistry).build()
  }
...
final public class Group : GeneratedMessage, GeneratedMessageProtocol {
  ...
  public class func parseFromData(data:NSData) -> Group {
    return Group.builder().mergeFromData(data, extensionRegistry:GoogleProtobufPerformanceRoot.sharedInstance.extensionRegistry).build()
  }
...
final public class PerfomanceBatch : GeneratedMessage, GeneratedMessageProtocol {
  ...
  public class func parseFromData(data:NSData) -> PerfomanceBatch {
    return PerfomanceBatch.builder().mergeFromData(data, extensionRegistry:GoogleProtobufPerformanceRoot.sharedInstance.extensionRegistry).build()
  }
...
final public class Perfomance : GeneratedMessage, GeneratedMessageProtocol {
  ...
  public class func parseFromData(data:NSData) -> Perfomance {
    return Perfomance.builder().mergeFromData(data, extensionRegistry:GoogleProtobufPerformanceRoot.sharedInstance.extensionRegistry).build()
  }
